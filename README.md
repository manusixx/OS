...
## Sesión III – Procesos y ejecución de programas

Esta sesión contiene materiales para explorar cómo el sistema operativo ejecuta programas y gestiona procesos.

Incluye:

* ejemplos de código utilizados durante la clase
* un ejercicio guiado
* un documento explicativo del ejercicio
...
├── ejemplos/
├── codigo_fuente/
└── ejercicio_ejemplo.docx
```

Los ejemplos permiten observar el comportamiento del sistema operativo durante la ejecución de programas.
